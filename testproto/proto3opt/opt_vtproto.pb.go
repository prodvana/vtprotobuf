...
func (this *OptionalFieldInProto3) StableEqualVT(that *OptionalFieldInProto3) bool {
	if this == that {
		return true
...
func (this *OptionalFieldInProto3) StableEqualMessageVT(thatMsg proto.Message) bool {
